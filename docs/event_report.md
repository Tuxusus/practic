...
**15 мая (BOOST-пати в МГТУ):**
- 16:00-22:00 - Мини-хакатон + нетворкинг
  - Наша команда разработала прототип чат-бота
  - Получили фидбек от ментора Яндекса
  - Выиграли мерч за лучший UX-дизайн
...
- **Практика**:
  - Мини-хакатон (разработка чат-бота)
  - Награда за лучший UX-дизайн
- **Нетворкинг**:
...
1. **Качество**:
   ...
   - UX улучшен на 25% (по тестам)
2. **Контент**:
   - 2 новых сюжетных веток
